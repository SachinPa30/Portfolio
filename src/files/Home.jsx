...
<div style={{position:"absolute" , zIndex:2 , left:"1060px", top:"280px" , color:"white", fontWeight:"bold"}}><h2 style={{fontSize:"30px"}}>Hi , i am sachin patil</h2>
<p style={{paddingTop:"5px", paddingLeft:"20px"}}>Backend Developer & Frontend Designer</p>
...
<div className='row' style={{display:"flex" , paddingTop:"8px" , paddingLeft:"8px" , paddingRight:"8px"}}>
   ...
   <div className='col-1'  style={{border:"2px solid black" , height:"130px" , width:"200px"  , backgroundColor: "green",}}><img src={img15} style={{height:"130px" , width:"200px" }}  onClick={instagramprofile}/></div>
